...
namespace scene
{
	 ...
	 **/
enum posPivot{ // AckisExtensions
pTopLeft = 0, // AckisExtensions
pBottomLeft, // AckisExtensions
pTopRight, // AckisExtensions
pBottomRight, // AckisExtensions
pCenter // AckisExtensions
}; // AckisExtensions
...
virtual void setPivot(posPivot pivot) = 0; // AckisExtensions
void applyTransformation(); // AckisExtensions
