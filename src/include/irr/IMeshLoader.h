...
// AckisExtensionsRemark:	virtual IAnimatedMesh* createMesh(io::IReadFile* file) = 0;
virtual IAnimatedMesh* createMesh(irr::io::IReadFile* file, const c8* password = "") = 0; // AckisExtensions
};
