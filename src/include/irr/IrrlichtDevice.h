...
#include "SIrrCreationParameters.h" // AckisExtensions
...
//! Holds the parameters of the device when created. // AckisExtensions
SIrrlichtCreationParameters curParam; // AckisExtensions
//! Returns the creation parameters of the device. // AckisExtensions
SIrrlichtCreationParameters getCreationParameter(){return curParam;} // AckisExtensions
