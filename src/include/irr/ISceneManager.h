...
#include "triangle3d.h" // AckisExtensions
...
class IAVIPlayer; // AckisExtensions
class ILensFlareSceneNode; // AckisExtensions
class IGridSceneNode; // AckisExtensions
class IDecalSceneNode; // AckisExtensions
...
virtual IAVIPlayer* createAVIPlayer() = 0; // AckisExtensions
virtual ILensFlareSceneNode* addLensFlareSceneNode(scene::ISceneNode* parent, const core::vector3df& position, s32 id = -1) = 0; // AckisExtensions
virtual IGridSceneNode* addGridSceneNode(u32 spacing = 10, u32 size = 1000, video::SColor gridcolor = video::SColor(255,128,128,128), u32 accentlineoffset = 10, video::SColor accentgridcolor = video::SColor(255,192,192,192), bool axislinestate = false, s32 id = -1, ISceneNode* parent = 0, ISceneManager* smgr = 0) = 0; // AckisExtensions
virtual IDecalSceneNode* addDecalSceneNode(scene::ISceneNode* parent, scene::ISceneManager* mgr, core::triangle3df tri, core::vector3df intersection, video::ITexture* image, float size) = 0; // AckisExtensions
		 ...
		 **/
// AckisExtensionsRemark:		virtual IAnimatedMesh* getMesh(const c8* filename) = 0;
virtual void encryptMeshFile(const c8* fileSource, const c8* fileTarget, const c8* password) = 0; // AckisExtensions
virtual IAnimatedMesh* getMesh(const c8* filename, const c8* password = "") = 0; // AckisExtensions
virtual ITerrainSceneNode* addTerrainSceneNode2(const char* heightMapFileName,ISceneNode* parent=0, s32 id=-1, // AckisExtensions
const core::vector3df& position = core::vector3df(0.0f,0.0f,0.0f),const core::vector3df& rotation = core::vector3df(0.0f,0.0f,0.0f), // AckisExtensions
const core::vector3df& scale = core::vector3df(1.0f,1.0f,1.0f),video::SColor vertexColor = video::SColor(255,255,255,255), // AckisExtensions
s32 maxLOD=5, E_TERRAIN_PATCH_SIZE patchSize=ETPS_17) = 0; // AckisExtensions
virtual ITerrainSceneNode* addTerrainSceneNode2(io::IReadFile* heightMapFile,ISceneNode* parent=0, s32 id=-1, // AckisExtensions
const core::vector3df& position = core::vector3df(0.0f,0.0f,0.0f),const core::vector3df& rotation = core::vector3df(0.0f,0.0f,0.0f), // AckisExtensions
const core::vector3df& scale = core::vector3df(1.0f,1.0f,1.0f),video::SColor vertexColor = video::SColor(255,255,255,255), // AckisExtensions
s32 maxLOD=5, E_TERRAIN_PATCH_SIZE patchSize=ETPS_17) = 0; // AckisExtensions
