...
virtual void setMoveSpeed(const f32 moveSpeed) = 0; // AckisExtensions
virtual void setRotateSpeed(const f32 rotateSpeed) = 0; // AckisExtensions
virtual f32 getMoveSpeed() = 0; // AckisExtensions
virtual f32 getRotateSpeed() = 0; // AckisExtensions
